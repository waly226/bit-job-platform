  ...
  static CoreController instance = Get.find();
    List<Map<String, dynamic>> data = [
      ...
      },
      {
        ...
        "identifiant": "ftx226",
        'image_path': 'assets/images/ftx.jpg',
        'offer_name': 'UI/UX Designer'
      },
      {
         'company_name': "OKLM",
        "identifiant": "ftx226",
        'image_path': 'assets/images/oklm.png',
        'offer_name': 'UI/UX Designer'
      },
      {
        'company_name': "Esante Company",
        "identifiant": "krones226",
        'image_path': 'assets/images/esante.png',
        'offer_name': 'Frontend Developper'
      },
      {
        'company_name': "Racine Tech",
        "identifiant": "bit226",
        'image_path': 'assets/images/racine.png',
        'offer_name': 'Backend Developper'
      },
      {
         'company_name': "Tam Tam Group",
        "identifiant": "ftx226",
        'image_path': 'assets/images/tamtam.png',
        'offer_name': 'UI/UX Designer'
      },
